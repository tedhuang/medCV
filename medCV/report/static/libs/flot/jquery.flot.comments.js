...
(function ($) {
    ...
    var options = {
        ...
        comment: {
            ...
            htmlTemplate: function() {
                return "<div class='{1}'><div class='callout' style='position: relative; margin: 0; padding: 0; background-color: {2}; width: 1%\0 /* IE 8 width hack */; box-sizing: border-box; padding: 5px;'><div style='line-height: 1em; position: relative;'>{{0}}</div><b class='notch' style='position: absolute; bottom: -{0}; left: 50%; margin: 0 0 0 -{0}; border-top: {0} solid {2}; border-left: {0} solid transparent; border-right: {0} solid transparent; border-bottom: 0; padding: 0; width: 0; height: 0; font-size: 0; line-height: 0; _border-right-color: pink; _border-left-color: pink; _filter: chroma(color=pink);'></b></div></div>".format(this.notch.size, this.class);
            },
            show: true,
            position: {
                offsetX: 0,
    ...
    function drawComments(plot) {
        ...
        if ($.isArray(comments) && commentOptions.show) {
            $.each(comments, function (index, comment) {
                var size = measureHtmlSize($(commentOptions.htmlTemplate().format(comment.contents, null, comment.color || "#000"))[0].innerHTML, plot.getPlaceholder()[0], commentOptions.wrapperCss || null);
                ...
                drawComment(plot, canvasX, canvasY, comment.contents, comment.color || "#000", commentOptions.wrapperCss);
            });
        }
    }

    function drawComment(plot, canvasX, canvasY, contents, color, style) {
        var commentOptions = plot.getOptions().comment;
        var html = commentOptions.htmlTemplate().format(contents, null, color);
